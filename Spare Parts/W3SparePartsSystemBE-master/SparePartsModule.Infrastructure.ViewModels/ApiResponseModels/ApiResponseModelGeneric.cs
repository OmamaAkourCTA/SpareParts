...
{
    public class ApiResponseModelGeneric<T>
    {
        [JsonPropertyName("id")]
        [MaybeNull]
        ...
        public ApiResponseModelGeneric(int statusCode, T data, int id = 0, int totalPage = 0,int TotalRecordsCount=0, int TotalAllRecordsCount = 0)
        {
        ...
        public ApiResponseModelGeneric(int statusCode, T data,object? info,  int totalPage = 0)
        {
            this.StatusCode = statusCode;
            this.Data = data;
            this.IsSuccess = true;
        ...
        public ApiResponseModelGeneric(int htppStatusCode, bool isSuccess, string abcErrorStatusCode, string? info = null, string? stackTrace = null, int id = 0, int totalPage = 0)
        {
