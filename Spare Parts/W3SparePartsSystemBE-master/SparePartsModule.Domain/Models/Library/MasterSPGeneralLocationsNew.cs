...
{
    public class MasterSPGeneralLocationsNew
    {
        [Key]
        public int LocationID { get; set; }
        public string LocationCode { get; set; }
        public int LocationWarehouseID { get; set; }
        public int? LocationSubWarehouseID { get; set; }
        public int LocationWHZoneID { get; set; }
        public int LocationWHShelfID { get; set; }
        public int LocationWHSectionID { get; set; }
